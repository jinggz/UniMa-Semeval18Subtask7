...
X = pd.read_csv('D:\\3nd Semester\\Semantic Relation Extraction\\MyCode\\ModelInput.csv', sep=',',
                usecols=['positionInSentence_x', 'wordsInSentence_x', 'wordLen_x', 'positionInSentence_y',
...
dataset = pd.read_csv('D:\\3nd Semester\\Semantic Relation Extraction\\MyCode\\ModelInput.csv', sep=',',
