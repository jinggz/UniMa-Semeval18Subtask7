...
df2 = pd.read_csv('F:\\Data Science\\Team Project\\tp\\ModelInput.csv', encoding='gbk',
                          usecols=['Entity id', 'positionInSentence_x', 'wordsInSentence_x', 'wordLen_x', 'relativePosition_x', 'positionInSentence_y',
                         'wordsInSentence_y', 'wordLen_y', 'relativePosition_y'])
...
features=[posInSentence,wordsInSentence,relativePos,wordLen,tfidf]
